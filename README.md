<h1 align="center">PHPColor - Colors</h1>
<p align="center">Repository for color palettes used in web interfaces.</p>
<img src="colors.svg" alt="Tailwind Colors" width="100%">

## Packages

| Name                                 | Composer instal             | Description                                          | 
|--------------------------------------|-----------------------------|------------------------------------------------------|
...
This [PHPColor](https://phpcolor.dev) project is released under the [MIT license](LICENSE).
